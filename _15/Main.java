...
public class Main {
     ...
     * A1: do while. I have to do my first cycle.
     *
     * Q2: We have a list of 1000 users to send emails to
     * A2: for each loop. I have to send it to every user.
     *
     * Q3: We want to print out the first 80 customer names from our bank database
     * A3: for i. I have to do it 80 times, a defined number of times.
     *
     * Q4: We want to read a file 100 lines at a time, without loading the full file into our program
     * A4: while. with the while I do the procedure only for the first 100 rows.
     */
}
